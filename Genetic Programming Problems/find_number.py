...
GP_1 = GP(pop_size=500, mutation_rate=0.5, fit=fitness_1, indiv_factory=individual_factory_1, termination_condition=lambda i: i == 50, is_crossover=True)
...
# Plot best, worst and average fitness per epoch (crossover)
plt.figure()
...
GP_1 = GP(pop_size=500, mutation_rate=0, fit=fitness_1, indiv_factory=individual_factory_1, termination_condition=lambda i: i == 50, is_crossover=False)
...
# Plot best, worst and average fitness per epoch (mutation)
plt.figure()
epochs = list(range(1, GP_1.generations() + 1))
plt.plot(epochs, GP_1.get_best_fitness())
plt.title('Best Fitness per Epoch')
plt.xlabel('Epoch number')
plt.ylabel('Fitness')
plt.savefig('best_fitness_1_mut.png')
...
plt.xlabel('Epoch number')
plt.ylabel('Fitness')
plt.savefig('worst_fitness_1_mut.png')
...
plt.xlabel('Epoch number')
plt.ylabel('Fitness')
plt.savefig('average_fitness_1_mut.png')
